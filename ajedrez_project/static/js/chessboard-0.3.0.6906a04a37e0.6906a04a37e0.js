...
function expandConfig() {
  ...
  if (cfg.hasOwnProperty('pieceTheme') !== true ||
    ...
    //cfg.pieceTheme = 'img/chesspieces/wikipedia/{piece}.png';	 //la original
	//cfg.pieceTheme = '../static/img/chesspieces/wikipedia/{piece}.png'; //para la version html
	//cfg.pieceTheme = '/static/img/chesspieces/wikipedia/{piece}.png'; //con el cambio dice en internet
	
	//cfg.pieceTheme = '/img/chesspieces/wikipedia/{piece}.png'; //con el cambio se usa la ruta absoluta
	cfg.pieceTheme = '/ajedrez/ajedrez_project/static/img/chesspieces/wikipedia/{piece}.png'; //con el cambio se usa la ruta absoluta
