...
<div class="row">
  <div class="col-xs-12">
    ...
    <div class="panel panel-default forumlist">
      <div class="panel-heading">
        <div class="row panel-row">
          ...
          <div class="col-md-1 forum-count-col hidden-sm hidden-xs">{% trans "Temas" %}</div>
          <div class="col-md-1 forum-count-col hidden-sm hidden-xs">{% trans "Publicacion" %}</div>
          <div class="col-md-2 col-sm-3 hidden-xs forum-last-post-col">{% trans "Última Publicación" %}</div>
        </div>
      </div>
    ...
    <b>{% trans "Subforums:" %}</b>&nbsp;
    {% endif %}
    <i class="fa fa-file"></i>&nbsp;<a href="{% url 'forum:forum' node.obj.slug node.obj.id %}">{{ node.obj.name }}</a>&nbsp;&nbsp;
    {% endif %}
